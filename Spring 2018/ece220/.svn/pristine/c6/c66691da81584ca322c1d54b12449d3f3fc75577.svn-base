...
NODE* lowest_common_ancestor (NODE* root , int first_number , int second_number )
{
	...
	NODE *left_tree=lowest_common_ancestor(root->left,first_number,second_number);
	NODE *right_tree=lowest_common_ancestor(root->right,first_number,second_number);
